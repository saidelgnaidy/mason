                  ...
                  child: Row(
                    children: [
                      ...
                      Visibility(
                          ...
                          child: TextButton(
                            style: TextButton.styleFrom(primary: widget.primaryColor ?? Colors.black),
                            child: const Icon(
                              Icons.clear,
                            ),
                            onPressed: () {
          ...
          children: [
            ...
            Visibility(
                ...
                child: Row(
                  children: [
                    TextButton(
                      style: TextButton.styleFrom(primary: widget.primaryColor ?? Colors.black, tapTargetSize: MaterialTapTargetSize.shrinkWrap),
                      child: Text(
                        'Select All',
                        style: widget.labelStyle != null
                            ? widget.labelStyle!.copyWith(
      ...
      child: Container(
        ...
        child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return TextButton(
                style: TextButton.styleFrom(
                    primary: widget.primaryColor ?? Colors.black, padding: const EdgeInsets.all(8), tapTargetSize: MaterialTapTargetSize.shrinkWrap),
                child: Padding(
