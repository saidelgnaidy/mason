...
import 'package:{{name}}/logic/global/currencies/currencies_bloc.dart';
      ...
      builder: (context, state) {
        ...
        return Column(
          children: [
            KDropdownBtn<String>(
              onChanged: onSelect,
              items: currency.map((e) => KHelper.of(context).dropdownItem<String>(itemText: "${e.name?.value}", value: "${e.symbols}")).toList(),
              hint: state.maybeWhen(orElse: () => false, loading: () => true) ? Tr.get.loading : Tr.get.select_currency,
