...
class NotificationCtrl {
  ...
  static Future _initNotification(Function(NotificationResponse)? onDidReceiveBackground, String? icon) async {
  ...
  static fcm_init(String channelName, {Function(NotificationResponse)? onDidReceiveBackground, String? icon}) async {
    await Firebase.initializeApp();
    FirebaseMessaging messaging = FirebaseMessaging.instance;
    await _initNotification(onDidReceiveBackground, icon);
