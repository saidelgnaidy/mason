...
_$_CountriesModel _$$_CountriesModelFromJson(Map<String, dynamic> json) =>
    _$_CountriesModel(
      ...
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => CountriesDatum.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
_$_CountriesDatum _$$_CountriesDatumFromJson(Map<String, dynamic> json) =>
    _$_CountriesDatum(
      id: json['id'] as int?,
...
Map<String, dynamic> _$$_CountriesDatumToJson(_$_CountriesDatum instance) =>
    <String, dynamic>{
      'id': instance.id,
